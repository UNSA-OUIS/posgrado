<template>
  <app-layout>
    <b-container>
            ...
            <div class="row justify-content-center mb-1">
                <fieldset class="col-12 col-md-6 px-3">
                    ...
                    <b-table-simple hover small caption-top stacked>
                        ...
                        <b-tbody>
                        <b-tr>
                            <b-th stacked-heading="Recogidos" v-text="recogidos"></b-th>
                            <b-th stacked-heading="Pendientes" v-text="pendientes"></b-th>
                        </b-tr>     
                        </b-tbody>
                    </b-table-simple>    
                </fieldset>
        ...
        <b-button class="btn-success ml-3" @click="exportReporte">Descarga total Excel</b-button>
...
export default {
    ...
    return {
      app_url: this.$root.app_url,
                fields: [
                    ...
                    { key: "usuario.name", label: "Entregado por"},
                ],
                index: 1,
                totalRows: 1,
                currentPage: 1,
  ...
  methods: {
    refreshTable() {
            ...
            exportReporte() {
                window.open(`${this.app_url}/tickets-reporte/export`, "_blank");
            },    
            myProvider(ctx) {                
                ...
                const promise = axios.get(`${this.app_url}/tickets-reporte/listar${params}`)
