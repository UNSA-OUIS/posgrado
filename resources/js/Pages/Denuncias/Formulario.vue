      ...
      <div class="row justify-content-center mb-1">
        <fieldset class="col-12 col-md-6 px-3">
            ...
            <div class="row justify-content-center">
                <b-form inline v-on:submit.prevent="buscarTicket">
                    <b-form-select
                    ...
                    <b-form-input
                        ...
                        required
                    ></b-form-input>
                    <b-button size="sm" variant="primary" type="submit">Buscar</b-button>                   
                </b-form>
                <div class="container">
    ...
    <div class="row justify-content-center mb-1" v-if="mostrar_resultado">
      <fieldset class="col-12 col-md-6 px-3">
          ...
          <b-table-simple hover small caption-top stacked v-if="formData !== null && opcion_busqueda == 'DNI'">
            ...
            <b-tbody>
              <b-tr>
                <b-th stacked-heading="Nro. Orden:" v-text="formData.id"></b-th>
                <b-td stacked-heading="DNI:" v-text="formData.dni"></b-td>
                <b-th stacked-heading="Apellidos y Nombres:" v-text="formData.apn"></b-th>
                <b-td stacked-heading="Tipo Personal:" v-text="formData.tipo_personal"></b-td>                
                <b-td v-if="formData.recogido == 0" stacked-heading="Estado:">
                  <h4><b-badge variant="success">No Recogido</b-badge></h4>
                </b-td>
                <b-td v-else stacked-heading="Estado:">
                  <h4><b-badge variant="danger">Recogido</b-badge></h4>
                </b-td>
                <b-td colspan="4"></b-td>
                <b-td colspan="4"></b-td>
...
export default {
  ...
  methods: {
    ...
    registrar() {
      this.$bvModal
        .msgBoxConfirm(`¿Esta seguro de querer registrar el ticket para el ${this.formData.tipo_personal}: ${this.formData.apn}?`, {
