<template>
  <app-layout>
    <dashboard-administrador
      v-if="user.tipo_usuario === 'ADMINISTRADOR'"
    ></dashboard-administrador>
    <formulario
      v-else-if="user.tipo_usuario === 'ADMINISTRADO'"
      :form="user"
    ></formulario>
  </app-layout>
</template>
...
import DashboardAdministrador from "./Dashboard_Administrador";
import Formulario from "@/Pages/Denuncias/Formulario.vue";
